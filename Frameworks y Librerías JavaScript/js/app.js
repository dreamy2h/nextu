...
$(function () {
    ...
    $('.btn-reinicio').click(function () {
        if ($('.btn-reinicio').text() === 'Iniciar') {
            ...
            limpiarIntervalo(idMovIntervalo);
...
function iniciarJuego() {
    ...
    $('#countdowntimer').countdowntimer({
        ...
        timeUp: function () {
            seguir = false;
            limpiarIntervalo(realizarMovimientos());
    ...
    idMovIntervalo = setInterval(realizarMovimientos, 1500);
}
...
function actualizarPoint(masPoint) {
    Point += masPoint;
